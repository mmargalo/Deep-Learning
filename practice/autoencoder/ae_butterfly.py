...
datasetTrain = DatasetGenerator(pathData, pathTrain, transformList, imgWidth, imgHeight, dataSize, 'false')
datasetTest = DatasetGenerator(pathData, pathTest, transformList, imgWidth, imgHeight, dataSize, 'false')
...
print(x_train.shape)
autoencoder.fit(x_train, x_train, epochs=50, batch_size=10, shuffle=True, validation_data=(x_test, x_test))
